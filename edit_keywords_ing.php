...
$id = $_GET['id'];
$query_rsMgtList = "SELECT * FROM keywords_ing where keyword_id = '$id'";
...
<?php include 'include/left_nav.php' ?>
    ...
    <div id="admin-body" class="admin-fRight">
        <h1>Edit Ingrdiant Keyword </h1>
        <form action="edit_keywords_confirm_ing.php" method="post" enctype="multipart/form-data" name="frm1" style="margin:0; padding:0;" >

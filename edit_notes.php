...
require_once('sessions/mysessionscript.php');
	...
	$mgtId = $_GET['id'];
	$mgtQry = mysqli_query($cn, "select * from notification where noid = '$mgtId'");
...
<?php include 'include/left_nav.php' ?>
    ...
    <div id="admin-body" class="admin-fRight">
		<h1>Edit Notes </h1>
		<form action="edit_news_confirm.php?id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data" style="margin:0; padding:0;">
        	<table border="0" cellspacing="4" cellpadding="4">
              <tr>
                <td><strong>Heading:</strong></td>
                <td><input type="text" name="heading" class="admin-inputBox" size="40" value="<?php echo $mgtRow['nohead']; ?>" onkeypress="return validateQty(event);" /></td>
              </tr>
			  <tr>
			    <td align="left" valign="top"><strong>Detail:</strong></td>
			    <td>
                                <textarea cols='60' rows='4' name='detail' id='detail'><?php echo $mgtRow['nodetail']; ?></textarea>
                            </td>
                          </tr>
			  <tr>

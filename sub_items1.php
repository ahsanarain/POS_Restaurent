          ...
          <?php $i=0; do { $i++; ?>
            ...
            <tr>
              ...
              <td class="admin-tbRow1" valign="top">
                  <strong><?=$row_rsMgtList['sub_item_name']; ?></strong>
                  <br>
                  <?php
                        $sql = "select item,amt,unit from sub_item_ing where sub_item_id = '".$row_rsMgtList['sub_item_id']."'";
            ...
            <td class="admin-tbRow1" valign="top" align='right'><?php echo $row_rsMgtList['price']; ?></td>
            <td class="admin-tbRow1" align="center" valign="top">
			  <?php
			  	if($row_rsMgtList['sub_item_status']==1)
				{
					echo "Publish";
				}
				else
				...
				<td class="admin-tbRow1" valign="top"><a href="images/subitems/<?php echo $row_rsMgtList['sub_item_image']; ?>"><img width="40" src="images/subitems/<?php echo $row_rsMgtList['sub_item_image']; ?>"></a></td>
              <td class="admin-tbRow1" align="center" valign="top"><a href="edit_sub_items.php?id=<?PHP echo $row_rsMgtList['sub_item_id']; ?>" title="Edit" class="admin-edit"></a></td>
              <td class="admin-tbRow1 admin-tbRow2" align="center" valign="top"><a href="delete_sub_items.php?id=<?PHP echo $row_rsMgtList['sub_item_id']; ?>" title="Delete" class="admin-del" onclick="return confirm('Are you sure you want to perform this action ?');"></a></td>
            </tr>

		...
		<form action="create_user_confirm.php" method="post" enctype="multipart/form-data" name="frm1" style="margin:0; padding:0;" >
        	<?php
              ...
              <tr>
                ...
                <td><input type="text" value="<?=(isset($dataArr['sname'])?$dataArr['sname']:'')?>" name="name" id="name" autocomplete="off" class="admin-inputBox" maxlength="50" size="40" onkeypress="return validateQty(event);"/></td>
              </tr>
              <tr>
                <td><strong><span class="redColor">*</span> User ID:</strong>(Without Spaces)</td>
                <td><input type="text" value="<?=(isset($dataArr['user_id'])?$dataArr['user_id']:'')?>" name="user_id" id="user_id" autocomplete="off" class="admin-inputBox" maxlength="50" size="40" onkeypress="return validateQty(event);"/></td>
              </tr>
              <tr>
                <td><strong><span class="redColor">*</span> Password:</strong> </td>
                <td><input type="password" name="password" value="<?=(isset($dataArr['password'])?$dataArr['password']:'')?>" id="password" autocomplete="off" class="admin-inputBox" maxlength="50" size="40" onkeypress="return validateQty(event);"/></td>
              </tr>
               <tr>
                <td><strong><span class="redColor">*</span> Phone #:</strong> </td>
                <td><input type="text" name="phone" id="phone" value="<?=(isset($dataArr['spno'])?$dataArr['spno']:'')?>"  autocomplete="off" class="admin-inputBox" maxlength="50" size="40" onkeypress="return numbersonly(event);"/></td>
              </tr> 
              <tr>
                <td><strong><span class="redColor">*</span> Designation:</strong> </td>
                <td><input type="text" name="designation" value="<?=(isset($dataArr['sdesig'])?$dataArr['sdesig']:'')?>"  id="designation" autocomplete="off" class="admin-inputBox" maxlength="50" size="40" onkeypress="return validateQty(event);"/></td>
              </tr>
               <tr>
                <td><strong><span class="redColor">*</span> Salary:</strong></td>
                <td><input type="text" name="salary" value="<?=(isset($dataArr['ssalary'])?$dataArr['ssalary']:'0')?>" id="salary" autocomplete="off" class="admin-inputBox" maxlength="50" size="40" onkeypress="return numbersonly(event);"/></td>
              </tr>
               <tr>
                <td><strong><span class="redColor">*</span> Service Charge %age:</strong> </td>
                <td><input type="text" name="service_charge" value="<?=(isset($dataArr['service'])?$dataArr['service']:'0')?>" id="service_charge" autocomplete="off" class="admin-inputBox" maxlength="50" size="40" onkeypress="return numbersonly(event);"/></td>
              </tr>
              <tr>
                <td><strong><span class="redColor">*</span> Address:</strong></td>
                <td><textarea name="address" cols="50" rows="2" id="address" class="admin-inputBox"><?=(isset($dataArr['saddress'])?$dataArr['saddress']:'')?></textarea></td>
              </tr>
              <tr>

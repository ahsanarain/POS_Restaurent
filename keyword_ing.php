...
$query_rsMgtList = "SELECT * FROM keywords_ing ORDER BY keyword_name ASC";
...
<title>Ingrediants Keywords</title>
...
<?php include 'include/left_nav.php' ?>
    ...
    <div id="admin-body" class="admin-fRight">
		<h1>List of Ingrediants Keywords</h1>
        <form action="add_keywords_ing.php" method="post">
		 ...
		 <tbody>
          <?php do { ?>
            <tr>
              ...
              <td class="admin-tbRow1" align="center" valign="top"><a href="edit_keywords_ing.php?id=<?PHP echo $row_rsMgtList['keyword_id']; ?>" title="Edit" class="admin-edit"></a></td>
              <td class="admin-tbRow1 admin-tbRow2" align="center" valign="top"><a href="del_keywords_ing.php?id=<?PHP echo $row_rsMgtList['keyword_id']; ?>" title="Delete" class="admin-del" onclick="return confirm('Are you sure you want to perform this action ?');"></a></td>
            </tr>

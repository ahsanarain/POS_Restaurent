...
$sqlMenu = "select distinct menu_head menuhead from res_functions";
$res = mysqli_query($cn, $sqlMenu) or die(mysqli_error($cn));
$arrData=array();
while($data= mysqli_fetch_assoc($res)) $arrData[] = $data['menuhead'];
?>
        ...
        <div id="admin-body" class="admin-fRight">
            ...
            <form action="edit_function_confirm.php?id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data" style="margin:0; padding:0;">
                <table border="0" cellspacing="4" cellpadding="4">
                    ...
                    <tr>
                        <td><strong>Add In Menu</strong></td>
                        <td>
                            <select id="addin" class="admin-inputBox" name="addin">
                                <?php foreach($arrData as $data){
                                    if($mgtRow['menu_head']==$data)
